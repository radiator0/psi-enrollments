...
import com.psi.service.dto.UserDTO;
import com.psi.service.mapper.UserMapper;
import com.psi.web.rest.vm.ManagedUserVM;
...
public class UserResourceIT {
    ...
    public void getAllAuthorities() throws Exception {
        restUserMockMvc.perform(get("/api/users/authorities")
            ...
            .andExpect(jsonPath("$").value(hasItems(AuthoritiesConstants.ADMIN, AuthoritiesConstants.LECTURER, AuthoritiesConstants.STUDENT)));
    }
