...
public class EnrollmentRightResourceIT {
    ...
    public void setup() {
        ...
        final EnrollmentRightResource enrollmentRightResource = new EnrollmentRightResource(enrollmentRightService);
        this.restEnrollmentRightMockMvc = MockMvcBuilders.standaloneSetup(enrollmentRightResource)
    ...
    public void testEntityFromId() {
        assertThat(enrollmentRightMapper.fromId(42L).getId()).isEqualTo(42);
