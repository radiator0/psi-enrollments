...
export const EnrollmentDate = (props: IEnrollmentDateProps) => {
  useEffect(() => {
    props.getEntities();
  }, []);

  const { enrollmentDateList, match, loading } = props;
  return (
    <div>
      <h2 id="enrollment-date-heading">
        ...
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          ...
          &nbsp;
          <Translate contentKey="enrollmentsApp.enrollmentDate.home.createLabel">Create new Enrollment Date</Translate>
        </Link>
      </h2>
...
const mapStateToProps = ({ enrollmentDate }: IRootState) => ({
  ...
  loading: enrollmentDate.loading,
});
...
export default connect(mapStateToProps, mapDispatchToProps)(EnrollmentDate);
