...
export class EnrollmentDateDeleteDialog extends React.Component<IEnrollmentDateDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.enrollmentDateEntity.id);
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-enrollmentDate" color="danger" onClick={this.confirmDelete}>
