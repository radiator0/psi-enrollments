...
export class EnrollmentDateDetail extends React.Component<IEnrollmentDateDetailProps> {
  componentDidMount() {
    ...
    return (
      <Row>
        <Col md="8">
          ...
          <Button tag={Link} to="/entity/enrollment-date" replace color="info">
          ...
          &nbsp;
          <Button tag={Link} to={`/entity/enrollment-date/${enrollmentDateEntity.id}/edit`} replace color="primary">
