...
export class EnrollmentRightDetail extends React.Component<IEnrollmentRightDetailProps> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="enrollmentsApp.enrollmentRight.detail.title">EnrollmentRight</Translate> [
            <b>{enrollmentRightEntity.id}</b>]
          </h2>
          ...
          <Button tag={Link} to="/entity/enrollment-right" replace color="info">
          ...
          &nbsp;
          <Button tag={Link} to={`/entity/enrollment-right/${enrollmentRightEntity.id}/edit`} replace color="primary">
