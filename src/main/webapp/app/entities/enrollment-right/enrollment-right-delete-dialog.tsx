...
export class EnrollmentRightDeleteDialog extends React.Component<IEnrollmentRightDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.enrollmentRightEntity.id);
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-enrollmentRight" color="danger" onClick={this.confirmDelete}>
