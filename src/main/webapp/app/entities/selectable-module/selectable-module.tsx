...
export const SelectableModule = (props: ISelectableModuleProps) => {
  useEffect(() => {
    props.getEntities();
  }, []);

  const { selectableModuleList, match, loading } = props;
  return (
    <div>
      <h2 id="selectable-module-heading">
        ...
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          ...
          &nbsp;
          <Translate contentKey="enrollmentsApp.selectableModule.home.createLabel">Create new Selectable Module</Translate>
        </Link>
      </h2>
...
const mapStateToProps = ({ selectableModule }: IRootState) => ({
  ...
  loading: selectableModule.loading,
});
...
export default connect(mapStateToProps, mapDispatchToProps)(SelectableModule);
