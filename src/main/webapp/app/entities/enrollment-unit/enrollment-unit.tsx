...
export const EnrollmentUnit = (props: IEnrollmentUnitProps) => {
  useEffect(() => {
    props.getEntities();
  }, []);

  const { enrollmentUnitList, match, loading } = props;
  return (
    <div>
      <h2 id="enrollment-unit-heading">
        ...
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          ...
          &nbsp;
          <Translate contentKey="enrollmentsApp.enrollmentUnit.home.createLabel">Create new Enrollment Unit</Translate>
        </Link>
      </h2>
...
const mapStateToProps = ({ enrollmentUnit }: IRootState) => ({
  ...
  loading: enrollmentUnit.loading,
});
...
export default connect(mapStateToProps, mapDispatchToProps)(EnrollmentUnit);
