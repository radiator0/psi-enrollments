...
export class EnrollmentUnitDeleteDialog extends React.Component<IEnrollmentUnitDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.enrollmentUnitEntity.id);
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-enrollmentUnit" color="danger" onClick={this.confirmDelete}>
