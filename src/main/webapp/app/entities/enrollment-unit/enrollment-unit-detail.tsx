...
export const EnrollmentUnitDetail = (props: IEnrollmentUnitDetailProps) => {
  useEffect(() => {
    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {enrollmentUnitEntity.startDate ? (
        ...
        <Button tag={Link} to="/enrollment-unit" replace color="info">
        ...
        &nbsp;
        <Button tag={Link} to={`/enrollment-unit/${enrollmentUnitEntity.id}/edit`} replace color="primary">
...
export default connect(mapStateToProps, mapDispatchToProps)(EnrollmentUnitDetail);
