...
export class CourseUnit extends React.Component<ICourseUnitProps> {
  componentDidMount() {
    this.props.getEntities();
  }

  render() {
    const { courseUnitList, match } = this.props;
    return (
      <div>
        <h2 id="course-unit-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="enrollmentsApp.courseUnit.home.createLabel">Create a new Course Unit</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {courseUnitList && courseUnitList.length > 0 ? (
            <Table responsive aria-describedby="course-unit-heading">
              <thead>
                <tr>
                  <th>
