...
export const CourseUnitDetail = (props: ICourseUnitDetailProps) => {
  useEffect(() => {
    props.getEntity(props.match.params.id);
  }, []);

  const { courseUnitEntity } = props;
  return (
    <Row>
      <Col md="8">
        <h2>
        ...
        <Button tag={Link} to="/course-unit" replace color="info">
        ...
        &nbsp;
        <Button tag={Link} to={`/course-unit/${courseUnitEntity.id}/edit`} replace color="primary">
...
export default connect(mapStateToProps, mapDispatchToProps)(CourseUnitDetail);
