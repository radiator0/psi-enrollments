...
export class ClassScheduleDetail extends React.Component<IClassScheduleDetailProps> {
  componentDidMount() {
      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            ...
            <dd>
              <TextFormat value={classScheduleEntity.endTime} type="date" format={APP_DATE_FORMAT} />
            </dd>
            <dt>
          ...
          <Button tag={Link} to="/entity/class-schedule" replace color="info">
          ...
          &nbsp;
          <Button tag={Link} to={`/entity/class-schedule/${classScheduleEntity.id}/edit`} replace color="primary">
