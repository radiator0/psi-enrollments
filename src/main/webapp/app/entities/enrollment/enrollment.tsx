...
export const Enrollment = (props: IEnrollmentProps) => {
  ...
  const { enrollmentList, match, loading } = props;
  return (
    <div>
      <h2 id="enrollment-heading">
        ...
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          ...
          &nbsp;
          <Translate contentKey="enrollmentsApp.enrollment.home.createLabel">Create new Enrollment</Translate>
        </Link>
      </h2>
            ...
            <tbody>
              {enrollmentList.map((enrollment, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{enrollment.date ? <TextFormat type="date" value={enrollment.date} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
