...
export class EnrollmentDetail extends React.Component<IEnrollmentDetailProps> {
  componentDidMount() {
      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            ...
            <dd>
              <TextFormat value={enrollmentEntity.date} type="date" format={APP_LOCAL_DATE_FORMAT} />
            </dd>
            <dt>
          ...
          <Button tag={Link} to="/entity/enrollment" replace color="info">
          ...
          &nbsp;
          <Button tag={Link} to={`/entity/enrollment/${enrollmentEntity.id}/edit`} replace color="primary">
