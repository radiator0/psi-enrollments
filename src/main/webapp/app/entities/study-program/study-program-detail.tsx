...
export const StudyProgramDetail = (props: IStudyProgramDetailProps) => {
  useEffect(() => {
  ...
  return (
    <Row>
      <Col md="8">
        ...
        <Button tag={Link} to="/study-program" replace color="info">
        ...
        &nbsp;
        <Button tag={Link} to={`/study-program/${studyProgramEntity.id}/edit`} replace color="primary">
...
export default connect(mapStateToProps, mapDispatchToProps)(StudyProgramDetail);
