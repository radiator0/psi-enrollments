...
export class StudyProgramDeleteDialog extends React.Component<IStudyProgramDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.studyProgramEntity.id);
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-studyProgram" color="danger" onClick={this.confirmDelete}>
