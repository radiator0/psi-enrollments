...
export const StudyProgramUpdate = (props: IStudyProgramUpdateProps) => {
  const [isNew, setIsNew] = useState(!props.match.params || !props.match.params.id);

  const { studyProgramEntity, loading, updating } = props;
      ...
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : studyProgramEntity} onSubmit={saveEntity}>
              {!isNew ? (
                <AvGroup>
              ...
              <Button tag={Link} id="cancel-save" to="/study-program" replace color="info">
...
export default connect(mapStateToProps, mapDispatchToProps)(StudyProgramUpdate);
