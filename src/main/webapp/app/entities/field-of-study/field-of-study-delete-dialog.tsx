...
export const FieldOfStudyDeleteDialog = (props: IFieldOfStudyDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="enrollmentsApp.fieldOfStudy.delete.question">
        <Translate contentKey="enrollmentsApp.fieldOfStudy.delete.question" interpolate={{ id: fieldOfStudyEntity.id }}>
