...
export interface IFieldOfStudyUpdateState {
  isNew: boolean;
  studyProgramId: string;
}

export class FieldOfStudyUpdate extends React.Component<IFieldOfStudyUpdateProps, IFieldOfStudyUpdateState> {
  constructor(props) {
    super(props);
    this.state = {
      studyProgramId: '0',
  ...
  handleClose = () => {
    this.props.history.push('/entity/field-of-study');
  };

  render() {
    const { fieldOfStudyEntity, studyPrograms, loading, updating } = this.props;
        ...
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : fieldOfStudyEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                ...
                <Button tag={Link} id="cancel-save" to="/entity/field-of-study" replace color="info">
