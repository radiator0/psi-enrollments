...
export const FieldOfStudy = (props: IFieldOfStudyProps) => {
  ...
  const { fieldOfStudyList, match, loading } = props;
  return (
    <div>
      <h2 id="field-of-study-heading">
        ...
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          ...
          &nbsp;
          <Translate contentKey="enrollmentsApp.fieldOfStudy.home.createLabel">Create new Field Of Study</Translate>
        </Link>
      </h2>
