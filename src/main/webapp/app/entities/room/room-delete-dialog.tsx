...
export class RoomDeleteDialog extends React.Component<IRoomDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.roomEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="enrollmentsApp.room.delete.question">
          <Translate contentKey="enrollmentsApp.room.delete.question" interpolate={{ id: roomEntity.id }}>
