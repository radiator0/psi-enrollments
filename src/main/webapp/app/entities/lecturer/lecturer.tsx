...
export class Lecturer extends React.Component<ILecturerProps> {
  componentDidMount() {
    this.props.getEntities();
  }

  render() {
    const { lecturerList, match } = this.props;
    return (
      <div>
        <h2 id="lecturer-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="enrollmentsApp.lecturer.home.createLabel">Create a new Lecturer</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {lecturerList && lecturerList.length > 0 ? (
            <Table responsive aria-describedby="lecturer-heading">
              <thead>
                <tr>
                  <th>
