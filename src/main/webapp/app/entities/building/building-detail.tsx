...
export const BuildingDetail = (props: IBuildingDetailProps) => {
  useEffect(() => {
    props.getEntity(props.match.params.id);
  }, []);

  const { buildingEntity } = props;
  return (
    <Row>
      <Col md="8">
        <h2>
        ...
        <Button tag={Link} to="/building" replace color="info">
        ...
        &nbsp;
        <Button tag={Link} to={`/building/${buildingEntity.id}/edit`} replace color="primary">
