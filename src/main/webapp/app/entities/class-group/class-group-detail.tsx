...
export class ClassGroupDetail extends React.Component<IClassGroupDetailProps> {
  componentDidMount() {
    ...
    return (
      <Row>
        <Col md="8">
          ...
          <Button tag={Link} to="/entity/class-group" replace color="info">
          ...
          &nbsp;
          <Button tag={Link} to={`/entity/class-group/${classGroupEntity.id}/edit`} replace color="primary">
