...
export const ClassGroup = (props: IClassGroupProps) => {
  ...
  const { classGroupList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="class-group-heading">
        ...
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          ...
          &nbsp;
          <Translate contentKey="enrollmentsApp.classGroup.home.createLabel">Create new Class Group</Translate>
        </Link>
      </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('isEnrollmentAboveLimitAllowed')}>
                  <Translate contentKey="enrollmentsApp.classGroup.isEnrollmentAboveLimitAllowed">
                    Is Enrollment Above Limit Allowed
                  </Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('peopleLimit')}>
                  <Translate contentKey="enrollmentsApp.classGroup.peopleLimit">People Limit</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('enrolledCount')}>
                  <Translate contentKey="enrollmentsApp.classGroup.enrolledCount">Enrolled Count</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('isFull')}>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${classGroup.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${classGroup.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
...
export default connect(mapStateToProps, mapDispatchToProps)(ClassGroup);
