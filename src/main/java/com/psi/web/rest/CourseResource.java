...
/**
 * REST controller for managing {@link com.psi.domain.Course}.
 */
@ApiIgnore
@RestController
@RequestMapping("/api")
public class CourseResource {
     ...
     */
    @GetMapping("/courses")
    public List<CourseDTO> getAllCourses(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
