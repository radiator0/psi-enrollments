...
public class SelectableModuleResource {
    ...
    public ResponseEntity<SelectableModuleDTO> createSelectableModule(@Valid @RequestBody SelectableModuleDTO selectableModuleDTO) throws URISyntaxException {
    ...
    public ResponseEntity<SelectableModuleDTO> updateSelectableModule(@Valid @RequestBody SelectableModuleDTO selectableModuleDTO) throws URISyntaxException {
